    ...
    describe('render', () => {
        ...
        describe('when data is not passed', () => {
            it('should throw an error', () => {
                expect(() => shallow(<BarComponent data={{}} />)).toThrow();
            });
        });
        ...
        describe('when data passed in', () => {
            ...
            it('should call the create method or the chart', () => {
                mount(<BarComponent chart={bar} data={barData.withLetters()} />);
            ...
            it('should call the create method or the chart with the container as the first argument', () => {
                const wrapper = mount(<BarComponent chart={bar} data={barData.withLetters()} />);
            ...
            it('should call the create method or the chart with the configuration object as the second argument', () => {
                ...
                mount(<BarComponent chart={bar} data={dataSet} />);
