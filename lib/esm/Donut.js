...
var _donutChart = __webpack_require__(63);
...
var DonutComponent = function (_Component) {
    _inherits(DonutComponent, _Component);
    ...
    function DonutComponent(props) {
        ...
        var _this = _possibleConstructorReturn(this, (DonutComponent.__proto__ || Object.getPrototypeOf(DonutComponent)).call(this, props));
    ...
    _createClass(DonutComponent, [{
        ...
        value: function render() {
            return _react2.default.createElement('div', { className: 'donut-container', ref: this._setRef.bind(this) });
        }
    }]);
...
DonutComponent.PropTypes = {
     ...
     */
    externalRadius: _propTypes2.default.number,
     ...
     */
    hasFixedHighlightedSlice: _propTypes2.default.boolean,
     ...
     */
    orderingFunction: _propTypes2.default.func,
...
var _donut = __webpack_require__(64);
