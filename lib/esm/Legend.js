...
var _LegendChart = __webpack_require__(69);
...
var LegendComponent = function (_React$Component) {
    ...
    _createClass(LegendComponent, [{
        ...
        value: function render() {
            return _react2.default.createElement('div', { className: 'legend-container', ref: this._setRef.bind(this) });
        }
    }]);
...
LegendComponent.propTypes = {
     ...
     */
    highlight: _propTypes2.default.number,
    /**
     ...
     */
    marginRatio: _propTypes2.default.number,
    /**
...
var _legend = __webpack_require__(70);
...
legend.update = function (el, data) {
    var configuration = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
