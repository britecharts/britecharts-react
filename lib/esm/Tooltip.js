...
var _tooltipChart = __webpack_require__(69);
...
var TooltipComponent = function (_React$Component) {
        ...
        if (props.render) {
            _this.childChart = props.render({
                createTooltip: function createTooltip() {
                    var tooltipContainer = _this._rootNode.querySelector('.metadata-group .vertical-marker-container');

                    if (tooltipContainer) {
                        _this.props.chart.create(tooltipContainer, _this._getChartConfiguration());
                    }
                },
    ...
    _createClass(TooltipComponent, [{
        ...
        value: function componentDidMount() {
            var tooltipContainer = this._rootNode.querySelector('.metadata-group .vertical-marker-container');
