...
var _tooltipChart = __webpack_require__(72);

var _tooltipChart2 = _interopRequireDefault(_tooltipChart);
...
var tooltipContainerSelector = '.metadata-group .vertical-marker-container';
...
var TooltipComponent = function (_React$Component) {
    ...
    function TooltipComponent(props) {
        ...
        var _this = _possibleConstructorReturn(this, (TooltipComponent.__proto__ || Object.getPrototypeOf(TooltipComponent)).call(this, props));
        ...
        _this._createTooltip = function () {
            var tooltipContainer = _this._rootNode.querySelector(tooltipContainerSelector);

            if (tooltipContainer) {
                _this._chart = _this.props.chart.create(tooltipContainer, _this._getChartConfiguration());
            }
        };

        if (props.render) {
            _this.childChart = props.render({
                data: props.data,
                createTooltip: _this._createTooltip,
                customMouseMove: _this._handleMouseMove.bind(_this),
                customMouseOut: _this._handleMouseOut.bind(_this),
                customMouseOver: _this._handleMouseOver.bind(_this)
            });
        }
        return _this;
    }
    ...
    _createClass(TooltipComponent, [{
        ...
        value: function componentDidUpdate() {
            var tooltipContainer = this._rootNode.querySelector(tooltipContainerSelector);
        ...
        value: function _handleMouseMove(dataPoint, topicColorMap, x, y) {
            ...
            var customMouseMove = this.props.customMouseMove;
        ...
        value: function _handleMouseOut() {
            // Update Tooltip State
            this.setState(function (state) {
                return _extends({}, state, { isActive: false });
            });

            var customMouseOut = this.props.customMouseOut;
        ...
        value: function _handleMouseOver() {
            // Update Tooltip State
            this.setState(function (state) {
                return _extends({}, state, { isActive: true });
            });

            var customMouseOver = this.props.customMouseOver;
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'tooltip-chart-wrapper', ref: this._setRef.bind(this) },
                this.childChart
            );
        }
    }]);
...
TooltipComponent.propTypes = {
     ...
     */
    dateCustomFormat: _propTypes2.default.string,
    /**
     ...
     */
    nameLabel: _propTypes2.default.string,
    /**
     * Gets or Sets shouldShowDateInTitle
     */
    shouldShowDateInTitle: _propTypes2.default.bool,
    /**
     ...
     */
    tooltipOffset: _propTypes2.default.shape({
     ...
     */
    topicLabel: _propTypes2.default.string,
    /**
     * Pass an override for the ordering of your tooltip
     */
    topicsOrder: _propTypes2.default.arrayOf(_propTypes2.default.string),
    /**
...
tooltip.create = function (el) {
    ...
    var chartConfigured = (0, _configuration.applyConfiguration)(chart, configuration);
